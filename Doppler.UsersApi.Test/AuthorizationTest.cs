...
namespace Doppler.UsersApi
{
        ...
        : IClassFixture<WebApplicationFactory<Startup>>
    {
        ...
        [Theory]
        [InlineData("/features", TOKEN_EMPTY, HttpStatusCode.OK)]
        [InlineData("/features", TOKEN_EXPIRE_20961002, HttpStatusCode.OK)]
        [InlineData("/features", TOKEN_EXPIRE_20330518, HttpStatusCode.OK)]
        [InlineData("/features", TOKEN_EXPIRE_20010908, HttpStatusCode.OK)]
        [InlineData("/features", TOKEN_BROKEN, HttpStatusCode.OK)]
        [InlineData("/features", TOKEN_SUPERUSER_EXPIRE_20961002, HttpStatusCode.OK)]
        [InlineData("/features", TOKEN_SUPERUSER_EXPIRE_20330518, HttpStatusCode.OK)]
        [InlineData("/features", TOKEN_SUPERUSER_EXPIRE_20010908, HttpStatusCode.OK)]
        [InlineData("/features", TOKEN_SUPERUSER_FALSE_EXPIRE_20330518, HttpStatusCode.OK)]
        [InlineData("/features", TOKEN_ACCOUNT_123_TEST1_AT_TEST_DOT_COM_EXPIRE_20961002, HttpStatusCode.OK)]
        [InlineData("/features", TOKEN_ACCOUNT_123_TEST1_AT_TEST_DOT_COM_EXPIRE_20330518, HttpStatusCode.OK)]
        [InlineData("/features", TOKEN_ACCOUNT_123_TEST1_AT_TEST_DOT_COM_EXPIRE_20010908, HttpStatusCode.OK)]
        public async Task GET_features_anonymous_should_accept_any_token(string url, string token, HttpStatusCode expectedStatusCode)
        {
            // Arrange
        ...
        [Theory]
        [InlineData("/accounts/123/features", HttpStatusCode.Unauthorized)]
        [InlineData("/accounts/test1@test.com/features", HttpStatusCode.Unauthorized)]
        ...
        [Theory]
        [InlineData("/accounts/123/features", TOKEN_EMPTY, HttpStatusCode.Unauthorized, "invalid_token", "error_description=\"The token has no expiration\"")]
        [InlineData("/accounts/123/features", TOKEN_EXPIRE_20961002, HttpStatusCode.Unauthorized, "invalid_token", "error_description=\"The token has no expiration\"")]
        [InlineData("/accounts/123/features", TOKEN_EXPIRE_20010908, HttpStatusCode.Unauthorized, "invalid_token", "error_description=\"The token expired at")]
        [InlineData("/accounts/123/features", TOKEN_BROKEN, HttpStatusCode.Unauthorized, "invalid_token", "")]
        [InlineData("/accounts/123/features", TOKEN_SUPERUSER_EXPIRE_20961002, HttpStatusCode.Unauthorized, "invalid_token", "error_description=\"The token has no expiration\"")]
        [InlineData("/accounts/123/features", TOKEN_SUPERUSER_EXPIRE_20010908, HttpStatusCode.Unauthorized, "invalid_token", "error_description=\"The token expired at")]
        [InlineData("/accounts/123/features", TOKEN_ACCOUNT_123_TEST1_AT_TEST_DOT_COM_EXPIRE_20961002, HttpStatusCode.Unauthorized, "invalid_token", "error_description=\"The token has no expiration\"")]
        [InlineData("/accounts/123/features", TOKEN_ACCOUNT_123_TEST1_AT_TEST_DOT_COM_EXPIRE_20010908, HttpStatusCode.Unauthorized, "invalid_token", "error_description=\"The token expired at")]
        [InlineData("/accounts/test1@test.com/features", TOKEN_EMPTY, HttpStatusCode.Unauthorized, "invalid_token", "error_description=\"The token has no expiration\"")]
        [InlineData("/accounts/test1@test.com/features", TOKEN_EXPIRE_20961002, HttpStatusCode.Unauthorized, "invalid_token", "error_description=\"The token has no expiration\"")]
        [InlineData("/accounts/test1@test.com/features", TOKEN_EXPIRE_20010908, HttpStatusCode.Unauthorized, "invalid_token", "error_description=\"The token expired at")]
        [InlineData("/accounts/test1@test.com/features", TOKEN_BROKEN, HttpStatusCode.Unauthorized, "invalid_token", "")]
        [InlineData("/accounts/test1@test.com/features", TOKEN_SUPERUSER_EXPIRE_20961002, HttpStatusCode.Unauthorized, "invalid_token", "error_description=\"The token has no expiration\"")]
        [InlineData("/accounts/test1@test.com/features", TOKEN_SUPERUSER_EXPIRE_20010908, HttpStatusCode.Unauthorized, "invalid_token", "error_description=\"The token expired at")]
        [InlineData("/accounts/test1@test.com/features", TOKEN_ACCOUNT_123_TEST1_AT_TEST_DOT_COM_EXPIRE_20961002, HttpStatusCode.Unauthorized, "invalid_token", "error_description=\"The token has no expiration\"")]
        [InlineData("/accounts/test1@test.com/features", TOKEN_ACCOUNT_123_TEST1_AT_TEST_DOT_COM_EXPIRE_20010908, HttpStatusCode.Unauthorized, "invalid_token", "error_description=\"The token expired at")]
        ...
        [Theory]
        [InlineData("/accounts/123/features", TOKEN_EXPIRE_20330518, HttpStatusCode.Forbidden)]
        [InlineData("/accounts/123/features", TOKEN_SUPERUSER_FALSE_EXPIRE_20330518, HttpStatusCode.Forbidden)]
        [InlineData("/accounts/456/features", TOKEN_ACCOUNT_123_TEST1_AT_TEST_DOT_COM_EXPIRE_20330518, HttpStatusCode.Forbidden)]
        [InlineData("/accounts/test1@test.com/features", TOKEN_EXPIRE_20330518, HttpStatusCode.Forbidden)]
        [InlineData("/accounts/test1@test.com/features", TOKEN_SUPERUSER_FALSE_EXPIRE_20330518, HttpStatusCode.Forbidden)]
        [InlineData("/accounts/test2@test.com/features", TOKEN_ACCOUNT_123_TEST1_AT_TEST_DOT_COM_EXPIRE_20330518, HttpStatusCode.Forbidden)]
        ...
        [Theory]
        [InlineData("/accounts/123/features", TOKEN_SUPERUSER_EXPIRE_20330518, HttpStatusCode.OK)]
        [InlineData("/accounts/123/features", TOKEN_ACCOUNT_123_TEST1_AT_TEST_DOT_COM_EXPIRE_20330518, HttpStatusCode.OK)]
        [InlineData("/accounts/test1@test.com/features", TOKEN_SUPERUSER_EXPIRE_20330518, HttpStatusCode.OK)]
        [InlineData("/accounts/test1@test.com/features", TOKEN_ACCOUNT_123_TEST1_AT_TEST_DOT_COM_EXPIRE_20330518, HttpStatusCode.OK)]
